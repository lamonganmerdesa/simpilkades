    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tambah Pendukung</li>
        </ol>
    </section>
    <section class="content">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Tambah Pendukung</h3>
            ...
            <table id="myTable1" class="responsive display nowrap table table-bordered table-striped" cellspacing="0" width="100%">
                ...
                <?php
					$i=1;
					$tp=mysqli_query($koneksi, "SELECT * FROM dpt WHERE status='0' ORDER BY id");
                    ...
                    <td>
                        <?php
							echo "
								...
								<a class='btn btn-warning btn-sm' href='?p=kartukeluarga&kk=$r[no_kk]'>&nbsp;&nbsp;&nbsp;KK</td>
							";
						?>
                    </td>
                </tr> 
