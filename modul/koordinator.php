    <?php
	    ...
	    $aksi		= "modul/proses_koordinator.php";
    ?>
		...
		<div class="box">
			<div class="box-header with-border">
				...
				<div class="block-options pull-right">
                    <a class="btn btn-danger btn-sm" href="?p=tambah_koordinator"><i class="fa fa-plus"></i> Tambah</a>
                </div>
            ...
            <table id="myTable1" class="responsive display nowrap table table-bordered table-striped" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><?php echo $r[koordinator]; ?></td>
                    <td>
                    <?php
						echo "
							<a class='btn btn-primary btn-sm' href='?p=koordinator_edit&id=$r[id]'><i class='fa fa-edit'></i>&nbsp;&nbsp;&nbsp;Edit</a>
